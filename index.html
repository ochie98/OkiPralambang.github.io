  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="#intro" class="navbar-brand scrollTo">Oki Pralambang</a>
			<button type="button" data-toggle="collapse" data-target="#navbarcollapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right">
				<span class="fa fa-bars"></span>
			</button>
			<div>
				<a href="?lang=eng"><img src="img/eng.jpg" alt="logo" width="25"></a>
				<a href="?lang=ind"><img src="img/ind.png" alt="logo" width="25"></a>
			</div>
			<div id="navbarcollapse" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
				  <li class="nav-item"><a href="#intro" class="nav-link link-scroll"><?php echo $lang_menu_home; ?></a></li>
				  <li class="nav-item"><a href="#about" class="nav-link link-scroll"><?php echo $lang_menu_about; ?></a></li>
				  <li class="nav-item"><a href="#services" class="nav-link link-scroll"><?php echo $lang_menu_service; ?></a></li>
				  <!--<li class="nav-item"><a href="#testimonials" class="nav-link link-scroll">Testimonials</a></li>-->
				  <li class="nav-item"><a href="#references" class="nav-link link-scroll"><?php echo $lang_menu_mywork; ?></a></li>
				  <li class="nav-item"><a href="#customers" class="nav-link link-scroll"><?php echo $lang_menu_client; ?></a></li>
				  <li class="nav-item"><a href="#contact" class="nav-link link-scroll"><?php echo $lang_menu_contact; ?></a></li>
				</ul>
			</div>
        </div>
      </nav>
    ...
    <!-- Intro Image-->
    <section id="intro" style="background: url(img/me.jpg) center center no-repeat; background-size: cover;" class="intro-section pb-2">
		<div class="container" style="margintop:100px">
			<div data-animate="fadeInDown" class="logo" style="top: 285px;"><img src="img/3.gif" alt="logo" width="130"></div>
			<h1 data-animate="fadeInDown" class="text-shadow mb-5">Oki Pralambang</h1>
			<p data-animate="slideInUp" class="h3 text-shadow text-400 text-center" style="color:#eaeaea">
				<?php echo $lang_banner; ?>
			</p>
		</div>
    </section>
    <!-- About-->
    <section id="about" class="about-section">
      <div class="container">
        <header class="text-center">
			<h2 data-animate="fadeInDown" class="title"><?php echo $lang_menu_about; ?></h2>
        </header>
        <div class="row">
			...
			<div data-animate="fadeInUp" class="col-lg-6">
				<div class="skill-item">
					...
					<div class="progress">
						<div role="progressbar" style="width: 85%" aria-valuenow="0" aria-valuemin="85" aria-valuemax="100" class="progress-bar progress-bar-skill1"></div>
					</div>
				</div>
				<div class="skill-item">
					<div class="progress-title">React Native</div>
					<div class="progress">
						<div role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="60" aria-valuemax="100" class="progress-bar progress-bar-skill2"></div>
					</div>
				</div>
				<div class="skill-item">
					<div class="progress-title">HTML coding</div>
					<div class="progress">
						<div role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="90" aria-valuemax="100" class="progress-bar progress-bar-skill3"></div>
					</div>
				</div>
				<div class="skill-item">
					<div class="progress-title">Bootstrap Template</div>
					<div class="progress">
						<div role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="85" aria-valuemax="100" class="progress-bar progress-bar-skill4"></div>
					</div>
				</div>
				<div class="skill-item">
					<div class="progress-title">Linux</div>
					<div class="progress">
						<div role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="65" aria-valuemax="100" class="progress-bar progress-bar-skill5"></div>
					</div>
				</div>
				<div class="skill-item">
					<div class="progress-title">Management Database</div>
					<div class="progress">
						<div role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="85" aria-valuemax="100" class="progress-bar progress-bar-skill5"></div>
					</div>
				</div>
			</div>
    ...
    <section id="services" class="bg-gradient services-section">
		<div class="container">
        <header class="text-center">
          <h2 data-animate="fadeInDown" class="title"><?php echo $lang_menu_service; ?></h2>
        </header>
        ...
        <div class="row showcase text-center"> 
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              ...
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">3</span><br>Websites</h5>
            </div>
          </div>
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              <div class="icon"><i class="fa fa-users"></i></div>
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">5</span><br>Administrator</h5>
            </div>
          </div>
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              <div class="icon"><i class="fa fa-phone"></i></div>
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">1</span><br>React Native</h5>
            </div>
          </div>
          <div data-animate="fadeInUp" class="col-lg-3 col-md-6">
            <div class="item">
              <div class="icon"><i class="fa fa-copy"></i></div>
              <h5 class="text-400 mt-4 text-uppercase"><span class="counter">9</span><br>Projects</h5>
            </div>
          </div>
        </div>
      </div>
    ...
    *** REFERENCES IMAGE ***
      ...
      <div class="container">
        <div class="col-sm-12">
          <div class="mb-5 text-center">
            <h2 data-animate="fadeInUp" class="title"><?php echo $lang_menu_mywork; ?></h2>
    ...
    <section id="contact" data-animate="bounceIn" class="contact-section contact">
      <div class="container">
        <header class="text-center">
          <h2 class="title"><?php echo $lang_menu_contact; ?></h2>
        </header>
        <div class="row">
